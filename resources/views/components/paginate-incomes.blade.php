...
<div class="paginate-incomes">
    ...
    <div class="d-flex flex-row justify-content-around">
        <form name="previousmonth" method="post" enctype="multipart/form-data" action="{{url('/reports/currentincomes')}}">
            @csrf
        ...
        <form name="nextmonth" method="post" enctype="multipart/form-data" action="{{url('/reports/currentincomes')}}">
            @csrf
            <div class="form-group mt-3 text-center">
                <label for="date"></label>
                <input type="hidden" name="date" value="{{$year}}-{{$month}}">
