...
<div class="d-flex flex-row justify-content-around">
    ...
    <div>
        <form name="delete" id="expense" method="get" enctype="multipart/form-data" action="{{url('/pdf/currentbudget')}}">
            @csrf
            <div class="form-group text-center">
                <button type="submit" class="btn btn-danger shadow-lg" name="date" value="{{$year}}-{{$month}}">Скачать в PDF</button>
                <br>
            </div>
        </form>
    </div>
